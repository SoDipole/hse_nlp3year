...
# abbreviations to keep as one token
...
# words with hyphen to keep as one token
...
for root, dirs, files in os.walk('./reviews_clean'):
    for file in files:
        if file.endswith('.txt'):
            ...
            words = text.split() # list of objects
            ...
            while i + 1 <= len(words) - 1:
                ...
                x1 = re.findall(cap_word, words[i])
